...
if __name__ == '__main__':
    ...
    parser.add_argument('--alpha', type=float, default=0.05, help='lr for actor')
    parser.add_argument('--beta', type=float, default=0.01, help='lr for critic')
    parser.add_argument('--training_iter', type=int, default=600, help='set the number of training episodes for agent')
